...
### คืออะไร
เป็นวิธีที่เราใช้การเข้ารหัสแบบ PQC มาเข้ารหัสข้อมูลก่อนเพื่อให้เป็น quantum-safe และเอาการเข้ารหัสแบบเก่ามาเข้ารหัสอีกทีเพื่อที่โครงสร้างแอปพลิเคชันเดิมยังคมรับข้อมูลนั้นได้
...
### คืออะไร 
เป็นแนวทางที่ระบบรองรับทั้ง classical cryptography และ NIST PQC ทำงานคู่ขนานกัน โดยที่การเลือกใช้ว่าจะเข้ารหัสแบบไหนนั้น ตัดสินใจในตอนที่แอปพลิเคชันทำงานจริง (runtime) ไม่ใช่ตอน deploy
...
### ข้อดี
* ช่วยให้ระบบเก่าและระบบใหม่ทำงานร่วมกันได้ในระหว่างช่วงเปลี่ยนผ่าน 
