...
### คืออะไร ( What ) 
เป็นวิธีที่เราใช้การเข้ารหัสตัวข้อมูลที่ถูกเข้ารหัสแบบเก่าอยู่แล้วมาเข้ารหัสแบบ PQC อีกครั้ง ( Encapsulate ) 

![alt text](<Screenshot 2569-04-02 at 20.21.56.png>)
